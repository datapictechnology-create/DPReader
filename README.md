...
Facilitated by a Datapic writer (DATAPIC PRESS) & Datapic reader (STANDARD DATAPIC READER).
...
3. Input web address of your Datapic to the reader to read at: datapictechnology.com.
Or create a link to the address of your Datapic.
4. Using a created link: htt//ww.datapictechnology.com/STD DATAPIC READER.php?ImpImgAdd=['remote address of Datapic'] 
...
* You do not have permission for the publishing of Datapics except on DATAPIC PRESS MODULE or here on GITHUB.
